#ifndef _UNZIP_H_INCLUDED_
#define _UNZIP_H_INCLUDED_
...
extern unzFile unzOpen (const char *path, BOOL write=FALSE);
...
// bodge
extern int unzGoToFile (unzFile file, ULONG pos, ULONG num_file );

#endif //_UNZIP_H_INCLUDED_
